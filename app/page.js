...
export default function Beranda() {
  ...
  const fitur = [
    ...
    },
    {
      ...
      description: "Koneksi langsung ke Polygon.io dengan data saham US real-time"
    },
    {
  ...
  const testimoni = [
    {
      ...
      profesi: "Trader Profesional",
              komentar: "Platform terbaik yang pernah saya gunakan! Data akurat dan real-time dari Polygon.io untuk trading saham US.",
      rating: 5,
      profit: "+285%"
    },
    {
        ...
        <div className="container mx-auto px-6 py-12">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Siap untuk melanjutkan trading dengan Polygon MT5?
            </p>
            <Link
              href="/dashboard"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Platform Trading
                <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> Polygon MT5 </span>
                Terdepan di Indonesia
              </h1>
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Rasakan pengalaman trading forex yang revolusioner dengan teknologi AI, 
                interface visual yang menawan, dan integrasi langsung dengan Polygon MT5. 
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              ...
              dari platform Polygon MT5 terbaik di Indonesia
            </p>
      ...
      <footer className="bg-slate-900 py-12">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Platform Trading Polygon MT5. Semua hak dilindungi.</p>
          </div>
        </div>
      </footer>
    </div>
